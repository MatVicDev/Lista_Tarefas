	...
	<head>
		...
		<script>
			...
			function editar(id, txt_tarefa) 
			{
				...
				inputText.type = 'text'
				inputText.name = 'tarefa'
				inputText.className = 'form-control'
				inputText.value = txt_tarefa
				...
				// Incluir o input no formulário
				form.appendChild(inputText)

				// Incluir o input no formulário
				form.appendChild(inputId)

				// Incluir o botão no formulário
									...
									<div class="row mb-3 d-flex align-items-center tarefa">
										...
										<div class="col-sm-3 mt-2 d-flex justify-content-between">
											<i class="fas fa-trash-alt fa-lg text-danger"
												onclick="remover(<?= $tarefa->id_tarefa ?>)"></i>
											<i class="fas fa-edit fa-lg text-info"
												onclick="editar(<?= $tarefa->id_tarefa ?>, '<?= $tarefa->tarefa ?>')"></i>
											<i class="fas fa-check-square fa-lg text-success"
												onclick="realizada(<?= $tarefa->id_tarefa?>)"></i>
										</div>
									</div>
								<?php } ?>
							</div>
